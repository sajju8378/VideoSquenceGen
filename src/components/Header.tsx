...
import { Film, Lock, Unlock, Cpu, Code2, ScrollText, ShieldCheck, Zap, RotateCcw } from 'lucide-react';
          ...
          <div className="flex items-center gap-1.5">
            ...
            {gpuLockActive && (
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg border border-amber-600/50 bg-amber-950/60 hover:bg-amber-900 text-amber-300 text-xs font-mono flex items-center gap-1 transition cursor-pointer"
                title="Force-reset GPU lock if stuck"
              >
